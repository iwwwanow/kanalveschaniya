...
- [ ] Перенести бота на домашний Raspberry Pi 3B + k3s (учебная цель заодно). Три флешки: boot (DietPi) / k3s data-dir / downloads. Подробности, история дебага обнаружения Pi в сети, план по USB-boot — `docs/diary/2026-08-19_raspberry-pi-hosting.md`
